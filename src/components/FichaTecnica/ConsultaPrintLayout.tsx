...
interface ConsultaPrintLayoutProps {
  ficha: FichaSalva;
}

export function ConsultaPrintLayout({ ficha }: ConsultaPrintLayoutProps) {
      ...
      <div className="print-section">
        ...
        <div className="print-grid print-grid-2">
          <div className="print-field">
            ...
            <div className="print-value">{ficha.formData.cliente || "—"}</div>
          </div>
          <div className="print-field">
            <div className="print-label">SOLICITANTE:</div>
            <div className="print-value">{ficha.formData.solicitante || "—"}</div>
          </div>
        </div>
        <div className="print-grid print-grid-3">
          <div className="print-field">
            <div className="print-label">FONE/EMAIL:</div>
            <div className="print-value">{ficha.formData.fone_email || "—"}</div>
          </div>
          <div className="print-field">
            <div className="print-label">DATA VISITA:</div>
            <div className="print-value">{ficha.formData.data_visita || "—"}</div>
          </div>
          <div className="print-field">
            <div className="print-label">DATA ENTREGA:</div>
            <div className="print-value">{ficha.formData.data_entrega || "—"}</div>
          </div>
        </div>
      </div>
      ...
      <div className="print-section">
        ...
        <div className="print-grid print-grid-2">
          <div className="print-field">
            ...
            <div className="print-value">{ficha.formData.nome_peca || "—"}</div>
          </div>
          <div className="print-field">
            <div className="print-label">QUANTIDADE:</div>
            <div className="print-value">{ficha.formData.quantidade || "1"}</div>
          </div>
        </div>
        <div className="print-field">
          <div className="print-label">SERVIÇO A SER REALIZADO:</div>
          <div className="print-value">{ficha.formData.servico || "—"}</div>
        </div>
      </div>
        ...
        <div className="print-grid print-grid-4">
          <div className="print-field">
            ...
            <div className="print-value print-radio-group">
              <span className="print-radio-item">HMC: {ficha.formData.execucao === 'HMC' ? '✓' : '—'}</span>
              <span className="print-radio-item">Cliente: {ficha.formData.execucao === 'CLIENTE' ? '✓' : '—'}</span>
            </div>
          </div>
          <div className="print-field">
            <div className="print-label">VISITA TÉCNICA:</div>
            <div className="print-value print-radio-group">
              <span className="print-radio-item">Sim: {ficha.formData.visita_tecnica === 'SIM' ? '✓' : '—'}</span>
              <span className="print-radio-item">Não: {ficha.formData.visita_tecnica === 'NAO' ? '✓' : '—'}</span>
            </div>
          </div>
          <div className="print-field">
            <div className="print-label">HORAS VISITA:</div>
            <div className="print-value">{ficha.formData.visita_horas || "—"}</div>
          </div>
          <div className="print-field">
            <div className="print-label">PEÇA AMOSTRA:</div>
            <div className="print-value">{formatRadioValue(ficha.formData.tem_peca_amostra)}</div>
          </div>
        </div>
        <div className="print-grid print-grid-3">
          <div className="print-field">
            <div className="print-label">PROJETO POR:</div>
            <div className="print-value">{formatRadioValue(ficha.formData.projeto_desenvolvido_por)}</div>
          </div>
          <div className="print-field">
            <div className="print-label">DESENHO:</div>
            <div className="print-value">{formatRadioValue(ficha.formData.desenho_peca)}</div>
          </div>
          <div className="print-field">
            <div className="print-label">FINALIZADO:</div>
            <div className="print-value">{formatRadioValue(ficha.formData.desenho_finalizado)}</div>
          </div>
        </div>
      </div>
      ...
      <div className="print-section">
        ...
        <div className="print-grid print-grid-4">
          <div className="print-field">
            ...
            <div className="print-value">{formatRadioValue(ficha.formData.pintura)}</div>
          </div>
          <div className="print-field">
            <div className="print-label">COR:</div>
            <div className="print-value">{ficha.formData.cor_pintura || "—"}</div>
          </div>
          <div className="print-field">
            <div className="print-label">GALVANIZAÇÃO:</div>
            <div className="print-value">{formatRadioValue(ficha.formData.galvanizacao)}</div>
          </div>
          <div className="print-field">
            <div className="print-label">TRAT. TÉRMICO:</div>
            <div className="print-value">{formatRadioValue(ficha.formData.tratamento_termico)}</div>
          </div>
        </div>
      </div>
      ...
      <div className="print-section">
        ...
        <div className="print-grid print-grid-3">
          <div className="print-field">
            ...
            <div className="print-value">{formatCheckbox(ficha.formData.transporte_caminhao_hmc)}</div>
          </div>
          <div className="print-field">
            <div className="print-label">PICKUP HMC:</div>
            <div className="print-value">{formatCheckbox(ficha.formData.transporte_pickup_hmc)}</div>
          </div>
          <div className="print-field">
            <div className="print-label">CLIENTE:</div>
            <div className="print-value">{formatCheckbox(ficha.formData.transporte_cliente)}</div>
          </div>
        </div>
      </div>
      ...
      <div className="print-section">
        ...
        <div className="print-grid print-grid-3">
          <div className="print-field">
            ...
            <div className="print-value">{ficha.formData.num_orcamento || "—"}</div>
          </div>
          <div className="print-field">
            <div className="print-label">OS:</div>
            <div className="print-value">{ficha.formData.num_os || "—"}</div>
          </div>
          <div className="print-field">
            <div className="print-label">NF:</div>
            <div className="print-value">{ficha.formData.num_nf_remessa || "—"}</div>
          </div>
        </div>
      </div>
      ...
      <div className="print-totals">
        ...
        <div className="print-grid print-grid-4">
          <div className="total-item">
            ...
            <div className="print-value">{ficha.calculos.horasPorPeca.toFixed(1)}h</div>
          </div>
          <div className="total-item">
          ...
          <div className="total-item">
            ...
            <div className="print-value">{formatCurrency(ficha.calculos.materialTodasPecas)}</div>
          </div>
        </div>
      </div>
    </div>
